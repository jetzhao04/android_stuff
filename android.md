...
- [stackoverflow](http://stackoverflow.com/tags/android/info)
- [android kickstarter](http://androidkickstartr.com/)

# java
- [java8 tutorial](https://github.com/winterbe/java8-tutorial#default-methods-for-interfaces)
...
# memory
- [MAT](https://developer.android.com/tools/debugging/debugging-memory.html)

# Good sample app
- [Google IO app](https://github.com/google/iosched)
- [Plaid](https://github.com/nickbutcher/plaid?utm_campaign=explore-email&utm_medium=email&utm_source=newsletter&utm_term=weekly)
...
# classroom
- [udacity android course](https://www.udacity.com/course/viewer#!/c-ud855/l-3961788738/m-4294896404)
- [Chet Hass's blog](https://medium.com/google-developers/developing-for-android-ii-bb9a51f8c8b9)
- [android reverse engineering 101](http://www.fasteque.com/android-reverse-engineering-101-part-1/)
- [codepath cliffpath](http://guides.codepath.com/android/Android-Design-Guidelines)

# design 
- [material palette](http://www.materialpalette.com/)
- [material icons](https://design.google.com/icons/)
- [material docs](http://materialdoc.com/)
...
- [layer visualizer](https://github.com/romannurik/LayerVisualizer)

# tools
- [parcelabler](http://www.parcelabler.com/)
- [json edit online](https://www.jsoneditoronline.org/)
- [dpi calculator](http://jennift.com/dpical.html)
- [device metric](https://design.google.com/tool/devices/)
- [dex2jar](https://github.com/pxb1988/dex2jar)
- [method counts](http://inloop.github.io/apk-method-count/)
